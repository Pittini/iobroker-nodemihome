const SkriptVersion = "0.1.6"; //vom 20.12.2020 / Link zu Git: https://github.com/Pittini/iobroker-nodemihome / Forum: https://forum.iobroker.net/topic/39388/vorlage-xiaomi-airpurifier-3h-u-a-inkl-token-auslesen
...
z++;
                ...
                if (AllDevicesRaw[x].model == "yeelink.light.strip2") {
                    log("Match at " + AllDevicesRaw[x].model)
                    device[z].on('properties', (data) => {
                        //log("data=" + JSON.stringify(data))
                        device[z].data = data
                ...
                log("Init Device# " + z + " - device=" + JSON.stringify(device[z]))
...
function RefreshDps(DeviceIndex) {
    ...
    TriggerLock = true;
    log("Data=" + JSON.stringify(device[DeviceIndex].data),"warn")
    return true
