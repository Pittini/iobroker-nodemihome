...
DefineDevice[7] = { // In arbeit - unvollständig
    ...
    setter: {
        "power": async function (obj, val) { await device[obj].setPower(val) },
        "guard-mode": async function (obj, val) { await device[obj].setBrightness(val) },
        "light.on": async function (obj, val) { await device[obj].setLight(val) },
    },
    common:
        [{ name: "guard-mode", format: "boolean", read: true, write: true },
        { name: "light.on", format: "boolean", read: true, write: true },
        { name: "power", format: "boolean", read: true, write: true }]
};

// TODO
//  https://miot-spec.org/miot-spec-v2/instance?type=urn:miot-spec-v2:device:fan:0000A005:zhimi-sa1:1
//  https://miot-spec.org/miot-spec-v2/instance?type=urn:miot-spec-v2:device:coffee-machine:0000A049:scishare-s1102:1
//  https://miot-spec.org/miot-spec-v2/instance?type=urn:miot-spec-v2:device:camera:0000A01C:mijia-v1:1
//  
//  https://miot-spec.org/miot-spec-v2/instance?type=urn:miot-spec-v2:device:plant-monitor:0000A030:hhcc-v1:1
