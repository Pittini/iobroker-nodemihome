const SkriptVersion = "0.2.8"; //vom 01.02.2021 / Link zu Git: https://github.com/Pittini/iobroker-nodemihome / Forum: https://forum.iobroker.net/topic/39388/vorlage-xiaomi-airpurifier-3h-u-a-inkl-token-auslesen
...
DefineDevice[0] = { // Tested and working
    ...
    common:
        [{ name: "air-purifier.on", type: "boolean", read: true, write: true, min: false, max: true },
        ...
        { name: "alarm.alarm", type: "number", read: true, write: true, min: 0, max: 100 },
        { name: "indicator-light.brightness", type: "number", read: true, write: true, min: 0, max: 2 },
        { name: "indicator-light.on", type: "boolean", read: true, write: true, min: false, max: true },
        { name: "environment.temperature", type: "number", read: true, write: false, min: -40, max: 125, unit: "°C" },
        ...
        { name: "physical-controls-locked.physical-controls-locked", type: "boolean", read: true, write: true, min: false, max: true }]
};
...
DefineDevice[14] = { // in progress, untested
    ...
    common:
        [{ name: "power", type: "boolean", read: true, write: true, min: false, max: true },
        ...
        { name: "temp_dec", type: "number", read: true, write: false },
        ...
        { name: "child_lock", type: "boolean", read: true, write: true, min: false, max: true }]
};
...
DefineDevice[15] = { // Tested and working
    ...
    common:
        [{ name: "air-purifier.on", type: "boolean", read: true, write: true, min: false, max: true },
        { name: "air-purifier.fault", type: "number", read: true, write: false, min: 0, max: 5, states: { 0: "No faults", 1: "m1_run", 2: "m1_stuck", 3: "no_sensor", 4: "error_hum", 5: "error_temp" } },
        { name: "air-purifier.mode", type: "number", read: true, write: true, min: 0, max: 3, states: { 0: "auto", 1: "sleep", 2: "favorite", 3: "fanset" } },
...
DefineDevice[1] = { // untested
    ...
    common:
        ...
        { name: "yaw", type: "boolean", read: true, write: true },
        { name: "mode", type: "boolean", read: true, write: true },
        { name: "sound", type: "boolean", read: true, write: true },
...
DefineDevice[9] = { // untested
    ...
    common:
        ...
        { name: "angle_enable", type: "boolean", read: true, write: true },
        { name: "fan_level", type: "number", read: true, write: true, min: 1, max: 4 },
        { name: "buzzer", type: "boolean", read: true, write: true },
        { name: "child_lock", type: "boolean", read: true, write: true },
        { name: "led_b", type: "boolean", read: true, write: true },
...
DefineDevice[3] = { // Tested and working
    ...
    common:
        ...
        { name: "led", type: "number", read: true, write: true, min: 0, max: 2, states: { 0: "bright", 1: "dim", 2: "off" } },
        { name: "buzzer", type: "boolean", read: true, write: true, min: false, max: true },
        { name: "temperature", type: "number", read: true, write: false, min: -40, max: 125, unit: "°C" },
        { name: "humidity", type: "number", read: true, write: false, min: 0, max: 100, unit: "%" },
        { name: "child_lock", type: "boolean", read: true, write: true, min: false, max: true },
        { name: "dry", type: "boolean", read: true, write: true, min: false, max: true },
...
DefineDevice[4] = { // untested
    ...
    common:
        [{ name: "humidifier.on", type: "boolean", read: true, write: true, min: false, max: true },
