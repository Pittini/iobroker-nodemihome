const SkriptVersion = "0.2.7"; //vom 23.01.2021 / Link zu Git: https://github.com/Pittini/iobroker-nodemihome / Forum: https://forum.iobroker.net/topic/39388/vorlage-xiaomi-airpurifier-3h-u-a-inkl-token-auslesen
...
DefineDevice[0] = { // Tested and working
    ...
    common:
        ...
        { name: "alarm.alarm", format: "number", read: true, write: true, min: 0, max: 100 },
        ...
        { name: "motor-speed.motor-speed", format: "number", read: true, write: false, min: 0, max: 3000, unit: "rpm" },
        { name: "motor-speed.motor-set-speed", format: "number", read: true, write: false, min: 0, max: 3000, unit: "rpm" },
        { name: "motor-speed.favorite-fan-level", format: "number", read: true, write: true, min: 0, max: 14 },
        { name: "use-time.use-time", format: "number", read: true, write: false },
...
DefineDevice[8] = { // untested
    ...
    common:
        [{ name: "air-purifier.on", format: "boolean", read: true, write: true, min: false, max: true },
        { name: "air-purifier.device fault", format: "number", read: true, write: false, min: 0, max: 5, states: { 0: "No faults", 1: "m1_run", 2: "m1_stuck", 3: "no_sensor", 4: "error_hum", 5: "error_temp" } },
...
DefineDevice[13] = { // Tested and working
    ...
    common:
        ...
        { name: "air-purifier.mode", format: "number", read: true, write: true, min: 0, max: 3, states: { 0: "auto", 1: "sleep", 2: "favorite", 3: "fanset" } },
        { name: "air-purifier.fan-level", format: "number", read: true, write: true, min: 1, max: 3 },
        { name: "alarm.volume", format: "number", read: true, write: true, min: 0, max: 100 },
        { name: "indicator-light.brightness", format: "number", read: true, write: true, min: 0, max: 2 },
        { name: "indicator-light.on", format: "boolean", read: true, write: true, min: false, max: true },
        { name: "environment.temperature", format: "number", read: true, write: false, min: -40, max: 125, unit: "°C" },
        { name: "motor-speed.motor1-speed", format: "number", read: true, write: false, min: 0, max: 3000, unit: "rpm" },
        { name: "motor-speed.motor1-set-speed", format: "number", read: true, write: false, min: 0, max: 3000, unit: "rpm" },
        { name: "motor-speed.favorite-level", format: "number", read: true, write: true, min: 0, max: 14 },
        { name: "use-time.use-time", format: "number", read: true, write: false },
        { name: "environment.relative-humidity", format: "number", read: true, write: false, min: 0, max: 100, unit: "%" },
        { name: "environment.pm2_5-density", format: "number", read: true, write: false, min: 0, max: 600 },
        { name: "filter.filter-life-level", format: "number", read: true, write: false, min: 0, max: 100, unit: "%" },
...
DefineDevice[14] = { // in progress, untested
    ...
    common:
        ...
        { name: "temp_dec", format: "number", read: true, write: false },
        { name: "humidity", format: "number", read: true, write: false, min: 0, max: 100, unit: "%" },
        { name: "aqi", format: "number", read: true, write: false },
        { name: "average_aqi", format: "number", read: true, write: false },
        { name: "led", format: "number", read: true, write: true, min: 0, max: 2, states: { 0: "bright", 1: "dim", 2: "off" } },
        { name: "bright", format: "number", read: true, write: false, min: 0, max: 100, unit: "%" },
        { name: "volume", format: "number", read: true, write: false, min: 0, max: 100, unit: "%" },
        { name: "filter1_life", format: "number", read: true, write: false, min: 0, max: 100, unit: "%" },
        { name: "f1_hour", format: "number", read: true, write: false },
        { name: "f1_hour_used", format: "number", read: true, write: false },
        { name: "motor1_speed", format: "number", read: true, write: false },
        { name: "motor2_speed", format: "number", read: true, write: false },
...
DefineDevice[15] = { // Tested and working
    ...
    common:
        ...
        { name: "air-purifier.mode", format: "number", read: true, write: true, min: 0, max: 3, states: { 0: "auto", 1: "sleep", 2: "favorite", 3: "fanset" } },
        { name: "alarm.alarm", format: "boolean", read: true, write: true, min: false, max: true },
        { name: "screen.brightness", format: "number", read: true, write: true, min: 0, max: 8 },
        { name: "environment.pm2_5-density", format: "number", read: true, write: false, min: 0, max: 600 },
        { name: "custom-service.moto-speed-rpm", format: "number", read: true, write: false, min: 0, max: 65535, unit: "rpm" },
        { name: "custom-service.favorite-speed", format: "number", read: true, write: true, min: 300, max: 2300, unit: "rpm" },
        { name: "filter.filter-life-level", format: "number", read: true, write: false, min: 0, max: 100, unit: "%" },
        { name: "filter.filter-used-time", format: "number", read: true, write: false, unit: "h" },
        { name: "physical-controls-locked.physical-controls-locked", format: "boolean", read: true, write: true, min: false, max: true }]
};
