const SkriptVersion = "0.1.15"; //vom 04.01.2021 / Link zu Git: https://github.com/Pittini/iobroker-nodemihome / Forum: https://forum.iobroker.net/topic/39388/vorlage-xiaomi-airpurifier-3h-u-a-inkl-token-auslesen
...
DefineDevice[3] = {
    ...
    common:
        ...
        { name: "mode", format: "number", read: true, write: true, min: 0, max: 3, states: { 0: "auto", 1: "silent", 2: "medium", 3: "high" } }]
};
DefineDevice[4] = {
    info: {},
