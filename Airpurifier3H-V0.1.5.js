const SkriptVersion = "0.1.5"; //vom 7.12.2020 / Link zu Git: https://github.com/Pittini/iobroker-nodemihome / Forum: https://forum.iobroker.net/topic/39388/vorlage-xiaomi-airpurifier-3h-u-a-inkl-token-auslesen
...
log("Starting MiHome" + SkriptVersion);

Init();

const SupportedModels = ["zhimi.airpurifier.mb3"];

// https://miot-spec.org/miot-spec-v2/instance?type=urn:miot-spec-v2:device:air-purifier:0000A007:zhimi-mb3:2
...
function PrepareDeviceDps(did) {
    ...
    if (did == 317335021) { //Purifier 3H
        ...
        DpCount++;
        States[DpCount] = { id: praefix0 + "." + did + ".Filterlife", initial: 1, forceCreation: false, common: { read: true, write: true, name: "Filterlife", type: "number", role: "level", unit: "%", min: 0, max: 100 } }; // 
        DpCount++;
        States[DpCount] = { id: praefix0 + "." + did + ".Filterused", initial: 1, forceCreation: false, common: { read: true, write: true, name: "Filterused", type: "number", role: "level", unit: "h", min: 0, max: 10000 } }; // 
